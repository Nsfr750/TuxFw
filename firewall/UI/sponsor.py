...
class SponsorDialog(QDialog):
    def __init__(self, parent=None, language_manager=None):
        ...
        self.language_manager = language_manager if hasattr(language_manager, 'get_text') else LanguageManager()
        if hasattr(self.language_manager, 'get_text'):
            self.tr = self.language_manager.get_text
        else:
        ...
        # Title
        title = QLabel(self.tr("sponsor.title", "Support Firewall"))
        ...
        <ul>
            <li>{self.tr('sponsor.other_ways.star', 'Star the project on')} <a href="https://github.com/Nsfr750/firewall">GitHub</a></li>
